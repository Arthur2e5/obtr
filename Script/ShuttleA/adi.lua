...
while not step_done do
  ...
  if v:get_navmode(NAVMODE.PROGRADE) == true then
     ...
     warning = {"That would be cheating. Please don't push this button again during this task.","Do you want to make me angry?","I can fail you for this, you know.","You seem to have serious attitude problems ...","That's it, test failed for obnoxius behaviour. If you want to retake it, you'll have to go through the tutorial again."}
     if ccount < 5 then
       ccount = ccount+1
     end
